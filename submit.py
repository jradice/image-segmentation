...
def display_assignment_5_output(submission):
...
def main():
  ...
  parser.add_argument('part', choices = ['assignment_5'])
  ...
  if args.part == 'assignment_5':
    display_assignment_5_output(submission)
  else:
